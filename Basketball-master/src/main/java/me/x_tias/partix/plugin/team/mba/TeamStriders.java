...
public class TeamStriders
    ...
    public TeamStriders() {
        ...
        this.name = Text.gradient("Sacramento Striders", this.secondColor, this.firstColor, true);
        ...
        this.block = Items.create(Material.SADDLE, this.name, "§r§7West");
    }
}
