...
public class TeamBreeze
    ...
    public TeamBreeze() {
        ...
        this.abrv = Text.gradient("BOS", this.secondColor, this.firstColor, true);
        this.name = Text.gradient("Boston Breeze", this.secondColor, this.firstColor, true);
        ...
        this.block = Items.create(Material.BREEZE_ROD, this.name, "§r§7East");
    }
}
