...
public class TeamDiscs
    ...
    public TeamDiscs() {
        ...
        this.abrv = Text.gradient("DEN", this.secondColor, this.firstColor, true);
        this.name = Text.gradient("Denver Discs", this.secondColor, this.firstColor, true);
        ...
        this.block = Items.create(Material.MUSIC_DISC_5, this.name, "§r§7West");
    }
}
