...
public class TeamSpurs
    ...
    public TeamSpurs() {
        ...
        this.name = Text.gradient("San Antonio Spurs", this.secondColor, this.firstColor, true);
        ...
        this.block = Items.create(Material.IRON_HOE, this.name, "§r§7West");
    }
}
