...
public class Team76ers
    ...
    public Team76ers() {
        ...
        this.abrv = Text.gradient("PHI", this.secondColor, this.firstColor, true);
        this.name = Text.gradient("Philadelphia 76ers", this.secondColor, this.firstColor, true);
        ...
        this.block = Items.create(Material.FIREWORK_STAR, this.name, "§r§7East");
    }
}
