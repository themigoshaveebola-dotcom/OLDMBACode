...
public class TeamRaptors
    ...
    public TeamRaptors() {
        ...
        this.name = Text.gradient("Toronto Raptors", this.secondColor, this.firstColor, true);
        ...
        this.block = Items.create(Material.BONE_BLOCK, this.name, "§r§7East");
    }
}
