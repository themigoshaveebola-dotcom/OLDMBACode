...
public class TeamMagma
    ...
    public TeamMagma() {
        ...
        this.abrv = Text.gradient("MIA", this.secondColor, this.firstColor, true);
        this.name = Text.gradient("Miami Magma", this.secondColor, this.firstColor, true);
        ...
        this.block = Items.create(Material.MAGMA_BLOCK, this.name, "§r§7East");
    }
}
