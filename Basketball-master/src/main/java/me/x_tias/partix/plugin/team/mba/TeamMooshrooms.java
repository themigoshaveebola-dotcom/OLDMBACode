...
public class TeamMooshrooms
        extends BaseTeam {
    public TeamMooshrooms() {
        int main = 795456;
        int light = 2318738;
        int dark = 7912992;
        ...
        this.name = Text.gradient("Minnesota Mooshrooms", this.secondColor, this.firstColor, true);
        ...
        this.block = Items.create(Material.RED_MUSHROOM, this.name, "§r§7West");
    }
}
