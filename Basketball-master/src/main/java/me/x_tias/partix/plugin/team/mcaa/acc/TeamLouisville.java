...
public final class TeamLouisville
        extends BaseTeam {
    public TeamLouisville() {
        int red = 13893670;
        int black = 0;
        int white = 0xFFFFFF;
        ...
        this.abrv = Text.gradient("LOU", this.firstColor, this.secondColor, true);
        this.name = Text.gradient("Louisville\u00a0Cardinals", this.firstColor, this.secondColor, true);
        ...
        this.block = Items.create(Material.RED_DYE, this.name, "§7ACC");
    }
}
