...
public class TeamPistons
    ...
    public TeamPistons() {
        ...
        this.name = Text.gradient("Detroit Pistons", this.secondColor, this.firstColor, true);
        ...
        this.block = Items.create(Material.PISTON, this.name, "§r§7East");
    }
}
