...
public class TeamNets
    ...
    public TeamNets() {
        ...
        this.name = Text.gradient("Brooklyn Nets", this.secondColor, this.firstColor, true);
        ...
        this.block = Items.create(Material.COBWEB, this.name, "§r§7East");
    }
}
