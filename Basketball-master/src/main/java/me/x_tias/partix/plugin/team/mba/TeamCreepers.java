...
public class TeamCreepers
    ...
    public TeamCreepers() {
        ...
        this.abrv = Text.gradient("LAC", this.secondColor, this.firstColor, true);
        this.name = Text.gradient("Los Angeles Creepers", this.secondColor, this.firstColor, true);
        ...
        this.block = Items.create(Material.CREEPER_HEAD, this.name, "§r§7West");
    }
}
