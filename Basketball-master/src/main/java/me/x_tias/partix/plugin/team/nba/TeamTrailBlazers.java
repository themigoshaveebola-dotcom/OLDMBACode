...
public class TeamTrailBlazers
        extends BaseTeam {
    public TeamTrailBlazers() {
        int main = 14694974;
        int light = 12898004;
        int dark = 0;
        ...
        this.abrv = Text.gradient("POR", this.secondColor, this.firstColor, true);
        this.name = Text.gradient("Portland Trail Blazers", this.secondColor, this.firstColor, true);
        ...
        this.block = Items.create(Material.FLINT_AND_STEEL, this.name, "§r§7West");
    }
}
