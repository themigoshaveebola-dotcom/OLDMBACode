...
public class TeamThunder
    ...
    public TeamThunder() {
        ...
        this.abrv = Text.gradient("OKC", this.secondColor, this.firstColor, true);
        this.name = Text.gradient("Oklahoma City Thunder", this.secondColor, this.firstColor, true);
        ...
        this.block = Items.create(Material.LIGHTNING_ROD, this.name, "§r§7West");
    }
}
