...
public class TeamTimberwolves
        extends BaseTeam {
    public TeamTimberwolves() {
        int main = 795456;
        int light = 2318738;
        int dark = 7912992;
        ...
        this.abrv = Text.gradient("MIN", this.secondColor, this.firstColor, true);
        this.name = Text.gradient("Minnesota Timberwolves", this.secondColor, this.firstColor, true);
        ...
        this.block = Items.create(Material.WOLF_SPAWN_EGG, this.name, "§r§7West");
    }
}
