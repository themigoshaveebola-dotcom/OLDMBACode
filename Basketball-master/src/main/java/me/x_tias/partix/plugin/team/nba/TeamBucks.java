...
public class TeamBucks
    ...
    public TeamBucks() {
        ...
        this.abrv = Text.gradient("MIL", this.secondColor, this.firstColor, true);
        this.name = Text.gradient("Milwaukee Bucks", this.secondColor, this.firstColor, true);
        ...
        this.block = Items.create(Material.OAK_SAPLING, this.name, "§r§7East");
    }
}
