...
public class TeamMavericks
        extends BaseTeam {
    public TeamMavericks() {
        int main = 21388;
        int light = 12109002;
        int dark = 11102;
        ...
        this.abrv = Text.gradient("DAL", this.secondColor, this.firstColor, true);
        this.name = Text.gradient("Dallas Mavericks", this.secondColor, this.firstColor, true);
        ...
        this.block = Items.create(Material.CROSSBOW, this.name, "§r§7West");
    }
}
