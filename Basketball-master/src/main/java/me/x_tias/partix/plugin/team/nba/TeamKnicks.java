...
public class TeamKnicks
    ...
    public TeamKnicks() {
        ...
        this.name = Text.gradient("New York Knicks", this.secondColor, this.firstColor, true);
        ...
        this.block = Items.create(Material.ORANGE_CONCRETE, this.name, "§r§7East");
    }
}
