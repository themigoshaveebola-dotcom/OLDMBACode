...
public class TeamSuns
    ...
    public TeamSuns() {
        ...
        this.name = Text.gradient("Phoenix Suns", this.secondColor, this.firstColor, true);
        ...
        this.block = Items.create(Material.GLOWSTONE, this.name, "§r§7West");
    }
}
