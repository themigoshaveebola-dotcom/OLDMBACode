...
public class TeamTotems
    ...
    public TeamTotems() {
        ...
        this.abrv = Text.gradient("TOR", this.secondColor, this.firstColor, true);
        this.name = Text.gradient("Toronto Totems", this.secondColor, this.firstColor, true);
        ...
        this.block = Items.create(Material.TOTEM_OF_UNDYING, this.name, "§r§7East");
    }
}
