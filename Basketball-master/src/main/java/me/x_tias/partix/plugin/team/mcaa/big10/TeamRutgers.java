...
public final class TeamRutgers
        extends BaseTeam {
    public TeamRutgers() {
        int red = 0xCC0000;
        int black = 0;
        ...
        this.abrv = Text.gradient("RUT", this.firstColor, this.secondColor, true);
        this.name = Text.gradient("Rutgers\u00a0Scarlet\u00a0Knights", this.firstColor, this.secondColor, true);
