...
public class TeamSwords
    ...
    public TeamSwords() {
        ...
        this.abrv = Text.gradient("SAS", this.secondColor, this.firstColor, true);
        this.name = Text.gradient("San Antonio Swords", this.secondColor, this.firstColor, true);
        ...
        this.block = Items.create(Material.IRON_SWORD, this.name, "§r§7West");
    }
}
