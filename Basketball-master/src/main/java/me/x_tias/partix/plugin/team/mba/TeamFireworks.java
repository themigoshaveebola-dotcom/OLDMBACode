...
public class TeamFireworks
        extends BaseTeam {
    public TeamFireworks() {
        int main = 13504833;
        int light = 12898004;
        int dark = 0;
        ...
        this.abrv = Text.gradient("HOU", this.secondColor, this.firstColor, true);
        this.name = Text.gradient("Houston Fireworks", this.secondColor, this.firstColor, true);
        ...
        this.block = Items.create(Material.FIREWORK_ROCKET, this.name, "§r§7West");
    }
}
