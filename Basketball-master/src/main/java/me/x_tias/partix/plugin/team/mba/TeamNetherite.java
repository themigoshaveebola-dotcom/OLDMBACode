...
public class TeamNetherite
        extends BaseTeam {
    public TeamNetherite() {
        int main = 27574;
        int light = 16090150;
        int dark = 12501186;
        ...
        this.abrv = Text.gradient("NYK", this.secondColor, this.firstColor, true);
        this.name = Text.gradient("New York Netherite", this.secondColor, this.firstColor, true);
        ...
        this.block = Items.create(Material.NETHERITE_INGOT, this.name, "§r§7East");
    }
}
