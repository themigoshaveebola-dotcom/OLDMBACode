...
public class TeamDiamonds
    ...
    public TeamDiamonds() {
        ...
        this.name = Text.gradient("Dallas Diamonds", this.secondColor, this.firstColor, true);
        ...
        this.block = Items.create(Material.DIAMOND, this.name, "§r§7West");
    }
}
