...
public class TeamCeltics
    ...
    public TeamCeltics() {
        ...
        this.name = Text.gradient("Boston Celtics", this.secondColor, this.firstColor, true);
        ...
        this.block = Items.create(Material.EMERALD, this.name, "§r§7East");
    }
}
