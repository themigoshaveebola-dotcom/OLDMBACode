...
public class TeamOaks
    ...
    public TeamOaks() {
        ...
        this.name = Text.gradient("Oklahoma City Oaks", this.secondColor, this.firstColor, true);
        ...
        this.block = Items.create(Material.OAK_LOG, this.name, "§r§7West");
    }
}
