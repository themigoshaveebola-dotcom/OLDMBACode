...
public class Team64s
    ...
    public Team64s() {
        ...
        this.name = Text.gradient("Philadelphia 64s", this.secondColor, this.firstColor, true);
        ...
        this.block = Items.create(Material.BUNDLE, this.name, "§r§7East");
    }
}
