...
public class TeamWarriors
    ...
    public TeamWarriors() {
        ...
        this.name = Text.gradient("Golden State Warriors", this.secondColor, this.firstColor, true);
        ...
        this.block = Items.create(Material.SHIELD, this.name, "§r§7West");
    }
}
