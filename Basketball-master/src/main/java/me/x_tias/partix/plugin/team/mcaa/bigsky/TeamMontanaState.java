...
public final class TeamMontanaState
        extends BaseTeam {
    public TeamMontanaState() {
        int blue = 13414;
        int gold = 13613180;
        int white = 0xFFFFFF;
        ...
        this.abrv = Text.gradient("MSU", this.secondColor, this.firstColor, true);
        this.name = Text.gradient("Montana\u00a0State\u00a0Bobcats", this.secondColor, this.firstColor, true);
