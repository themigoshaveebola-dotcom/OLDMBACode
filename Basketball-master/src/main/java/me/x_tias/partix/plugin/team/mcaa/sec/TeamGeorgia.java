...
public class TeamGeorgia
    ...
    public TeamGeorgia() {
        ...
        this.abrv = Text.gradient("UGA", this.secondColor, this.firstColor, true);
        this.name = Text.gradient("Georgia Bulldogs", this.secondColor, this.firstColor, true);
