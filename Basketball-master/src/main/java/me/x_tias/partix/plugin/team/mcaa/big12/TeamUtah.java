...
public final class TeamUtah
    ...
    public TeamUtah() {
        ...
        this.abrv = Text.gradient("UTAH", this.firstColor, this.secondColor, true);
        this.name = Text.gradient("Utah\u202fUtes", this.firstColor, this.secondColor, true);
