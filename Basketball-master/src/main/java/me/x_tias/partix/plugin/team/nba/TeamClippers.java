...
public class TeamClippers
    ...
    public TeamClippers() {
        ...
        this.name = Text.gradient("Los Angeles Clippers", this.secondColor, this.firstColor, true);
        ...
        this.block = Items.create(Material.SHEARS, this.name, "§r§7West");
    }
}
