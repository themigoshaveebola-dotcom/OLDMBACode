...
public class TeamAllays
    ...
    public TeamAllays() {
        ...
        this.name = Text.gradient("Los Angeles Allays", this.secondColor, this.firstColor, true);
        ...
        this.block = Items.create(Material.RED_DYE, this.name, "§r§7West");
    }
}
