...
public class TeamLakers
    ...
    public TeamLakers() {
        ...
        this.abrv = Text.gradient("LAL", this.secondColor, this.firstColor, true);
        this.name = Text.gradient("Los Angeles Lakers", this.secondColor, this.firstColor, true);
        ...
        this.block = Items.create(Material.AMETHYST_BLOCK, this.name, "§r§7West");
    }
}
