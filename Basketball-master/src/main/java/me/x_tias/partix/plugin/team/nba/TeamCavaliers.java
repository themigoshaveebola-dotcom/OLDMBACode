...
public class TeamCavaliers
        extends BaseTeam {
    public TeamCavaliers() {
        int main = 8781880;
        int light = 16628528;
        int dark = 0;
        ...
        this.abrv = Text.gradient("CLE", this.secondColor, this.firstColor, true);
        this.name = Text.gradient("Cleveland Cavaliers", this.secondColor, this.firstColor, true);
        ...
        this.block = Items.create(Material.IRON_SWORD, this.name, "§r§7East");
    }
}
