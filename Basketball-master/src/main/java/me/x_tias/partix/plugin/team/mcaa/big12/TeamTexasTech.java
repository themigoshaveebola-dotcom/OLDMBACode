...
public final class TeamTexasTech
        extends BaseTeam {
    public TeamTexasTech() {
        int red = 0xCC0000;
        int black = 0;
        int grey = 0xA3A3A3;
        ...
        this.abrv = Text.gradient("TTU", this.firstColor, this.secondColor, true);
        this.name = Text.gradient("Texas\u202fTech\u202fRed\u202fRaiders", this.firstColor, this.secondColor, true);
