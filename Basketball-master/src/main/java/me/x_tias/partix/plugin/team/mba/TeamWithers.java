...
public class TeamWithers
    ...
    public TeamWithers() {
        ...
        this.name = Text.gradient("Washington Withers", this.secondColor, this.firstColor, true);
        ...
        this.block = Items.create(Material.WITHER_SKELETON_SKULL, this.name, "§r§7East");
    }
}
