...
public class TeamArrows
    ...
    public TeamArrows() {
        ...
        this.abrv = Text.gradient("ATL", this.secondColor, this.firstColor, true);
        this.name = Text.gradient("Atlanta Aarows", this.secondColor, this.firstColor, true);
        ...
        this.block = Items.create(Material.ARROW, this.name, "§r§7East");
    }
}
