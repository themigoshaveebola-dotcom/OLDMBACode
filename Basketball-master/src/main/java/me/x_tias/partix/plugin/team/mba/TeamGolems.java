...
public class TeamGolems
    ...
    public TeamGolems() {
        ...
        this.name = Text.gradient("Utah Golems", this.secondColor, this.firstColor, true);
        ...
        this.block = Items.create(Material.IRON_BLOCK, this.name, "§r§7West");
    }
}
