...
public class TeamChickens
    ...
    public TeamChickens() {
        ...
        this.name = Text.gradient("Cleveland Chickens", this.secondColor, this.firstColor, true);
        ...
        this.block = Items.create(Material.FEATHER, this.name, "§r§7East");
    }
}
