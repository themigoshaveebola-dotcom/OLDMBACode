...
public class TeamKings
    ...
    public TeamKings() {
        ...
        this.name = Text.gradient("Sacramento Kings", this.secondColor, this.firstColor, true);
        ...
        this.block = Items.create(Material.TRIDENT, this.name, "§r§7West");
    }
}
