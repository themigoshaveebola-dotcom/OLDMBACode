...
public class TeamOcelots
    ...
    public TeamOcelots() {
        ...
        this.abrv = Text.gradient("ORL", this.secondColor, this.firstColor, true);
        this.name = Text.gradient("Orlando Ocelots", this.secondColor, this.firstColor, true);
        ...
        this.block = Items.create(Material.OCELOT_SPAWN_EGG, this.name, "§r§7East");
    }
}
