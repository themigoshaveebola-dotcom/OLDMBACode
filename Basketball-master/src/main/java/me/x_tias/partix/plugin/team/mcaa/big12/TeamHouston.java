...
public final class TeamHouston
        extends BaseTeam {
    public TeamHouston() {
        int red = 13111342;
        int black = 0;
        ...
        this.abrv = Text.gradient("HOU", this.firstColor, this.secondColor, true);
        this.name = Text.gradient("Houston Cougars", this.firstColor, this.secondColor, true);
