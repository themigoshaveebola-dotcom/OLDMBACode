...
public final class TeamOklahomaState
        extends BaseTeam {
    public TeamOklahomaState() {
        int orange = 16741120;
        int black = 0;
        int grey = 10857647;
        ...
        this.name = Text.gradient("Oklahoma\u202fState\u202fCowboys", this.firstColor, this.secondColor, true);
        ...
        this.block = Items.create(Material.ORANGE_GLAZED_TERRACOTTA, this.name, "§7BIG‑12");
    }
}
