...
public class TeamPelicans
    ...
    public TeamPelicans() {
        ...
        this.name = Text.gradient("New Orleans Pelicans", this.secondColor, this.firstColor, true);
        ...
        this.block = Items.create(Material.ELYTRA, this.name, "§r§7West");
    }
}
